  ...
  return (
    <div className="revu-wrapper">
      <div className="revu-background">
        ...
        <button className="circular ui black icon button get-started" onClick={() => window.open("/login", "_self")}>GET STARTED</button>
      </div>
      <div className="revu-summary" style={{display: 'flex'}}>
        <div className="revu-card">
        ...
        <div className="revu-card">
          ...
          <p>With advanced filter and sort options, you find the perfect colleges for you, and add some colleges to your Favorites in order to compare them. With quick-search functionality, it’s always easy to jump to a school.</p>
          <p>Select your favorite colleges and, presto, you’ve built a powerful spreadsheet that you can view in-app.</p>
          <p>Visit your favorites to compare and visualize the differences in ACT and SAT requirements, Cost, and Admission Rate.</p>
          <p>Use our application manager to keep track of the applications you have started, written essay for, and submitted.</p>
        </div>
        <div className="revu-card">
